    ...
    if (isset($_POST['cambiar'])) {
      if (empty($errors) === true) {
        if ($_POST['status'] === '3' && $_POST['fechaEntregado'] == NULL) {
          ...
          header('Location: proyectListNoActivos.php?exito&var='.$idProyecto);
          exit();
        }
      }           
    }
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Lista de Proyectos <span style="color: #FCB322;"><strong>NO Activos</strong></span></h3><strong>Activos</strong></span></h3>
            <?php
              ...
              <div class="row mt">
                <div class="col-lg-8">
                  <div class="form-group">
                    <div class="alert alert-success col-sm-8 col-sm-8 control-label" id="quitar"><b>¡Genial!</b> El proyecto <strong><?php echo nombreCliente($project_data['nombreCliente']); ?>-<?php echo nombreProyecto($project_data['nombreProyecto']);?>-<?php echo marcaCliente($project_data['marcaCliente']); ?></strong> ha sido modificado.</div>
                  </div>
                </div>
              </div>
            <?php
          		...
          		<div class="col-lg-12">
                    ...
                    <table class="display" id="proyectsTable">
                      ...
                      <hr>
                        ...
                        <tbody>
                        <?php
                          $result = listProjectsNOactivos();
                          while ($row = mysql_fetch_array($result)) {?>
                            <tr>
                              <td><a href="projectDescr.php?var=<?=$row['idProyecto']?>" style="color: #F0FFF0;"><button class="btn btn-xs" style="background: #<?=$row['colorProyecto']?>;"><?php echo nombreCliente($row['nombreCliente']); ?>-<?php echo marcaCliente($row['marcaCliente']); ?>-<?php echo nombreProyecto($row['nombreProyecto']);?>-<?php echo actividadProyecto($row['actividadProyecto']); ?></button></a></td>
                              <td>
