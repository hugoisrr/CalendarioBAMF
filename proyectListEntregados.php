    ...
    if (isset($_POST['cambiar'])) {
      if (empty($errors) === true) {
        if ($_POST['status'] !== '3' && $_POST['fechaEntregado'] != NULL) {
          ...
          header('Location: proyectListEntregados.php?exito&var='.$idProyecto);
          exit();
        }else{
          $idProyecto = $_POST['idProyecto'];   
          $proyecto = $_POST['proyecto'];
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Lista de Proyectos <span style="color: #A9D86E;"><strong>Entregados</strong></span></h3>
            <?php
