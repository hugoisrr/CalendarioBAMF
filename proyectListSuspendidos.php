    ...
    if (isset($_POST['cambiar'])) {
      if (empty($errors) === true) {
        if ($_POST['status'] === '3' && $_POST['fechaEntregado'] == NULL) {
          ...
          header('Location: proyectListSuspendidos.php?exito&var='.$idProyecto);
          exit();
        }
      }           
    }
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Lista de Proyectos <span style="color: #FF6C60;"><strong>Suspendidos</strong></span></h3>
            <?php
          		...
          		<div class="col-lg-12">
                    ...
                    <table class="display" id="proyectsTable">
                      ...
                      <hr>
                        ...
                        <tbody>
                        <?php
                          $result = listProjectsSuspendidos();
