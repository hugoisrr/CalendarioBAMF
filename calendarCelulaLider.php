...
<html lang="es">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Calendario de Proyectos de <strong>Célula de 
              <?php if ($celula === '0') {
              echo "Consumo";
            }
            elseif ($celula === '1') {
          	...
          	<div class="row mt">               
               <!-- **********************************************************************************************************************************************************
              CALENDAR CÉLULA CONTENT
              *********************************************************************************************************************************************************** -->
              <aside class="col-lg-12 mt">
                  <section class="panel">
                      <div class="panel-body">
                          <div id="calendarCelula" class="has-toolbar"></div>
                      </div>
                  </section>
              </aside>
          	</div>			
  ...
  ?>
    ...
    <!-- variable para llamar el calendario específico de una célula -->
    <script type="text/javascript">var celula = "<?= $celula ?>";</script>
    <!-- Se hacen llamar las funciones para la creación de eventos y/o modificación en el calendario -->
    <script src="assets/js/eventsCelulaLider.js"></script> 
