...
<html lang="es">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h3 id="myModalLabel1">Creación de Evento</h3>
            </div>
                ...
                <div class="form-group" id="projectsByClient">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" name="projectList" id="projectList">
                      <option value="0"></option>                    
                      <!-- A través de la función AJAX muestra la lista de proyectos por cliente. -->
                    </select>
                  </div>
                </div>                
              </form>
                      ...
                      <?php
                        ...
                        if ($num_rows < 1 && $num_rows2 < 1){
                          ...
                          <select class="form-control" id="projectList">
                            <option value="0">--- Proyectos Célula Consumo ---</option>
                        <?php
                          while ($row = mysql_fetch_array($result)) {
                        ?>                           
                        ...
                        <?php
                          ...
                          ?>
                            <option value="0">--- Proyectos Célula Corporativo ---</option>
                        <?php
  ...
  ?>
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <!-- Función AJAX para mostrar Select proyectos por Cliente -->
